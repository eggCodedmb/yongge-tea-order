...
| 页面描述 | 界面预览 |
| :--- | :--- |
| **首页** - 品牌活动与功能入口 | ![首页](产品图/产品图-首页.png) |
| **门店选择** - 查找周边门店 | ![门店列表](产品图/产品图-门店列表.png) |
| **点单主页** - 商品分类与导航 | ![点单](产品图/产品图-点单.png) |
| **商品详情** - 规格与定制化选项 | ![商品详情](产品图/产品图-商品详情png.png) |
| **购物车** - 已选商品概览 | ![购物车](产品图/产品图-购物车01.png) |
| **购物车管理** - 商品编辑与删除 | ![购物车管理](产品图/产品图-购物车管理.png) |
| **地址管理 01** - 收货地址列表 | ![地址管理01](产品图/产品图-地址管理01.png) |
| **地址管理 02** - 编辑/新增地址 | ![地址管理02](产品图/产品图-地址管理02.png) |
| **订单中心** - 历史订单列表 | ![订单列表](产品图/产品图-订单.png) |
| **订单详情** - 自取状态 | ![订单详情-自取](产品图/产品图-订单详情-自取.png) |
| **订单详情** - 自取详情 01 | ![订单详情-自取01](产品图/产品图-订单详情-自取01.png) |
| **订单详情** - 自取详情 02 | ![订单详情-自取02](产品图/产品图-订单详情-自取02.png) |
| **订单详情** - 自取详情 03 | ![订单详情-自取03](产品图/产品图-订单详情-自取03.png) |
| **订单详情** - 外卖配送 01 | ![订单详情-外卖01](产品图/产品图-订单详情-外卖01.png) |
| **订单详情** - 外卖配送 02 | ![订单详情-外卖02](产品图/产品图-订单详情-外卖02.png) |
| **订单详情** - 已取消状态 | ![订单详情-取消](产品图/产品图-订单详情-取消.png) |
| **个人中心** - 会员信息与功能入口 | ![个人中心](产品图/产品图-个人.png) |
